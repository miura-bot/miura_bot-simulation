...
targetVelocitySlider = p.addUserDebugParameter("targetVelocity", -100, 100, 0)
#targetVelocitySlider2 = p.addUserDebugParameter("targetVelocity2", -100, 100, 100)
